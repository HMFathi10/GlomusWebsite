...
<html dir="rtl" lang="ar">
    ...
    <body>
        ...
        <div>
            ...
            ?>
            <div class="container">
                <form method="get" action="OccasionTemp.php" style="padding: 30px;font-size: 23px;text-align: right">
                    <div class="row">
                        <div class="col-25">
                            <label for="fname">الأســــم </label>
                        </div>
                        <div class="col-75">
                    ...
                    <div class="row">
                        <div class="col-25">
                            <label for="fname">رقــم الـمـوبـايـل </label>
                        </div>
                        <div class="col-75">
                    ...
                    <div class="row">
                        <div class="col-25">
                            <label for="fname">الـعـنـوان</label>
                        </div>
                        <div class="col-75">
                    ...
                    <div class="row">
                        <div class="col-25">
                            <label for="fname">الـمـنـاسـبـة</label>
                        </div>
                        <div class="col-75">
                            <input type="text" id="OccasionDes" name="OccasionDes">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                            <label for="fname">تـاريـج الـمـنـاسـبـة</label>
                        </div>
                        <div class="col-75">
                            <input type="date" id="OccasionDate" name="OccasionDate">
                        </div>
                    </div>
