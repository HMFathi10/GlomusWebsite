...
if ($Type == 1) {
    $DiscountCheck = $_POST['DiscountCheck'];
    $DiscountCost = $_POST['DiscountCost'];
    $sql1 = "call InsertIntoOrder('" . $Type . "','','','','','" . $DiscountCheck . "','" . $DiscountCost . "','" . $Cost . "','0','" . true . "','" . false . "')";
    ...
    $sql1 = "call InsertIntoOrder('" . $Type . "','" . $CustomerName . "','" . $CustomerPhoneNumber . "','" . $CustomerAddress . "','','" . false . "','','" . $Cost . "','" . $DeliveryCost . "','" . true . "','" . false . "')";
    $results1 = mysqli_query($conn1, $sql1);
...
while ($row = mysqli_fetch_assoc($results)) {
    $sql2 = "call InsertIntoOrderDescription('" . $row11['OrderID'] . "','" . $row['ProID'] . "','" . $row['ProName'] . "','" . $row['ProDest'] . "','" . $row['ProType'] . "','" . $row['ProQty'] . "','" . $row['ProCost'] . "','" . $row['ProTotalCost'] . "','" . false . "')";
